  ...
  (dolist
      (entry (reverse
              '(((agda-mode nil)       . agda)
                ((sh-mode nil)         . bash)
                ((c-mode nil)          . c)
                ((csharp-mode nil)     . c-sharp)
                ((c++-mode nil)        . cpp)
                ((d-mode nil)          . d)
                ((css-mode nil)        . css)
                ((elm-mode nil)        . elm)
                ((elixir-mode nil)     . elixir)
                ((go-mode nil)         . go)
                ((hcl-mode nil)        . hcl)
                ((html-mode nil)       . html)
                ((mhtml-mode nil)      . html)
                ((nix-mode nil)        . nix)
                ((java-mode nil)       . java)
                ((javascript-mode nil) . javascript)
                ((js-mode nil)         . javascript)
                ((js2-mode nil)        . javascript)
                ((js3-mode nil)        . javascript)
                ((json-mode nil)       . json)
                ((jsonc-mode nil)      . json)
                ((julia-mode nil)      . julia)
                ((ocaml-mode "ml")     . ocaml)
                ((ocaml-mode "mli")    . ocaml-interface)
                ((php-mode nil)        . php)
                ((prisma-mode nil)     . prisma)
                ((python-mode nil)     . python)
                ((pygn-mode nil)       . pgn)
                ((rjsx-mode nil)       . javascript)
                ((ruby-mode nil)       . ruby)
                ((rust-mode nil)       . rust)
                ((rustic-mode nil)     . rust)
                ((scala-mode nil)      . scala)
                ((swift-mode nil)      . swift)
                ((tuareg-mode "ml")    . ocaml)
                ((tuareg-mode "mli")   . ocaml-interface)
                ((typescript-mode nil) . typescript)
                ((zig-mode nil)        . zig))))
